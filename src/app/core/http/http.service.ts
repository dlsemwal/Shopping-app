...
import { categoriesUrl, productsUrlByCatId, productByIdUrl, cartUrl, brandsUrl, productsUrl, allProductsUrl } from '../../configs/config';
...
export class HttpService {
  ...
  getProducts() {
    return  this.http.get(allProductsUrl);
  }
